...
export default function renderAnimalInfo(animal: IAnimal) {
  ...
  if (animal.skills !== undefined) {
    const skills: HTMLUListElement = getListOfSkills(animal); //H! Skriv funktion som kollar om det finns skills, om det är en array eller inte osv. returnera en ul med skillsen i 
